...
cdef class Vector2DList(CList):
    ...
    cdef extendList(self, list values)
    cdef extendTuple(self, tuple values)
    cdef Py_ssize_t searchIndex(self, Vector2 value)

    cdef Vector2DList getValuesInSlice(self, slice sliceObject)
    cdef setValuesInSlice(self, slice sliceObject, values)
    cdef removeValuesInSlice(self, slice sliceObject)
    ...
    cdef getValueAtIndex(self, Py_ssize_t index)
    cdef setValueAtIndex(self, Py_ssize_t index, Vector2 value)
    cdef removeValueAtIndex(self, Py_ssize_t index)
    ...
    # Helpers
    cdef tryConversion(self, value, Vector2* target)
    cdef toPyObject(self, Vector2* value)
    cdef equals_SameType(self, Vector2DList other)
    cdef tryCorrectIndex(self, Py_ssize_t index)
...
cdef class ColorList(CList):
    ...
    cdef extendList(self, list values)
    cdef extendTuple(self, tuple values)
    cdef Py_ssize_t searchIndex(self, Color value)

    cdef ColorList getValuesInSlice(self, slice sliceObject)
    cdef setValuesInSlice(self, slice sliceObject, values)
    cdef removeValuesInSlice(self, slice sliceObject)
    ...
    cdef getValueAtIndex(self, Py_ssize_t index)
    cdef setValueAtIndex(self, Py_ssize_t index, Color value)
    cdef removeValueAtIndex(self, Py_ssize_t index)
    ...
    # Helpers
    cdef tryConversion(self, value, Color* target)
    cdef toPyObject(self, Color* value)
    cdef equals_SameType(self, ColorList other)
    cdef tryCorrectIndex(self, Py_ssize_t index)
